...
type VermouthGrpcClient interface {
	...
	LoadBalance(ctx context.Context, in *LoadBalanceReq, opts ...grpc.CallOption) (*Res, error)
}
...
func (c *vermouthGrpcClient) LoadBalance(ctx context.Context, in *LoadBalanceReq, opts ...grpc.CallOption) (*Res, error) {
	out := new(Res)
	err := c.cc.Invoke(ctx, "/vermouth_grpc.VermouthGrpc/LoadBalance", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type VermouthGrpcServer interface {
	...
	LoadBalance(context.Context, *LoadBalanceReq) (*Res, error)
...
func (UnimplementedVermouthGrpcServer) LoadBalance(context.Context, *LoadBalanceReq) (*Res, error) {
...
func _VermouthGrpc_LoadBalance_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(LoadBalanceReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(VermouthGrpcServer).LoadBalance(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/vermouth_grpc.VermouthGrpc/LoadBalance",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(VermouthGrpcServer).LoadBalance(ctx, req.(*LoadBalanceReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var VermouthGrpc_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _VermouthGrpc_LoadBalance_Handler,
		},
	},
